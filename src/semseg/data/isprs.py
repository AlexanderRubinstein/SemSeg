...
class IsprsDataset():
    ...
    def label_to_one_hot_batch(self, label_batch):
        # print("label size: {}".format(label_batch.size))
        #  # DEBUG_BEGIN
        # print("old shape of label_batch: {0}".format(label_batch.shape))
        # # DEBUG_END
        if label_batch.ndim == 4:
            # print("we want to squeeze: {}".format(label_batch.shape))
            ...
            # print("not squeezed but without 3rd axis: {}".format(label_batch.shape))
        ...
        # # DEBUG_BEGIN
        # print("number of labels: {0}".format(nb_labels))
        # print("new shape of label_batch: {0}".format(label_batch.shape))
        # # print(label_batch)
        # # DEBUG_END
        ...
        # # DEBUG_BEGIN
        # print("shape of one_hot_batch: {0}".format(one_hot_batch.shape))
        # # print(one_hot_batch)
        # # DEBUG_END
