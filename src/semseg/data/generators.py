...
class FileGenerator(Generator):
    ...
    def __init__(self, active_input_inds, train_ratio, cross_validation):
        ...
        # DEBUG
        # print("Train ratio is: {0}".format(self.train_ratio))
        ...
        if self.train_ratio is not None:
            ...
            # DEBUG
            # print ("Set train file inds")

            self.train_file_inds = self.file_inds[0:nb_train_inds]

            print("File inds are: {0}".format(self.train_file_inds))
    ...
    def make_batch_generator(self, file_inds, target_size, batch_size, shuffle,
        ...
        while True:
            ...
            # DEBUG
            # print("Batch from generator after getting samples shape: {}".format(batch.shape))
    ...
    def make_split_generator(self, split, target_size=None,
        ...
        def transform(x):
            ...
            # print("All_batch_x shape: {}".format(all_batch_x.shape))

            # Add ndvi channel to batch_x
            if self.dataset.include_ndvi:    
                all_batch_x = self.dataset.augment_channels(all_batch_x)

            # print("Color + ir + ndsm channels batch after channels augmentation shape: {}".format(all_batch_x.shape))
