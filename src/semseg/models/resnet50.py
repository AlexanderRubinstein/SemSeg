...
# Merge is deprecated, therefore use Add() instead
...
def conv_block(input_tensor, kernel_size, filters, stage, block, strides=(2, 2)):
    ...
    shortcut = Conv2D(nb_filter3, (1, 1), name=conv_name_base + '1',
                      strides=(1, 1))(input_tensor)
...
def ResNet50(include_top=True, weights='imagenet',
    ...
    # DEBUG
    # print ("Input shape is: {}".format(input_shape))
    # print ("Dimension ordering type: {}".format(K.image_dim_ordering()))
    ...
    if input_tensor is None:
        ...
        if not K.is_keras_tensor(input_tensor):
            ...
            # DEBUG_BEGIN
            # print ("We set img_input as img_tensor.")
            # DEBUG_END
    if K.image_dim_ordering() == 'tf':
        bn_axis = 3
    else:
    ...
    # DEBUG
    # print ("img_input shape is: {}".format(img_input.shape))    
    ...
    if weights == 'imagenet':
        if K.image_dim_ordering() == 'th':
            ...
            # DEBUG
            print ("Ready to load weights from: {}".format(weights_path))
            print ("Dimension ordering type: {}".format(K.image_dim_ordering()))
